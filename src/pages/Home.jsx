...
{ team_a: 'Brazil', team_b: 'Morocco', group: 'Group E', date: 'Jun 12', matchId: '6a20ec5003fec97668e1177e', img: 'https://media.base44.com/images/public/6a1da108eb293de119e4e930/bd940d5d7_image.png', odds_a: 1.85, odds_b: 4.20, odds_draw: 3.50 },
      ...
      <div className="grid md:grid-cols-2 gap-4">
        ...
        <motion.div
          ...
          <div className="relative z-10 pt-2 sm:pt-6">
            ...
            <button
              onClick={() => navigator.clipboard.writeText('3ecFdHPbcU88UQ37iStPcGaz7Bg16RdSDDYqW5FzPabu')}
              ...
              <span className="text-[10px] sm:text-[11px] font-bold text-white/60 tracking-wide">Solana Program ID: 3ecFdHPbcU88UQ37iStPcGaz7Bg16RdSDDYqW5FzPabu</span>
              ...
              <Link to={`/match/${match.id}`} className="group block">
                <motion.div
                  ...
                  <div className="relative h-40 -mx-4 -mt-4 mb-3 overflow-hidden rounded-t-2xl">
                    <img
                      src={featuredImg || WC_PHOTOS[i % WC_PHOTOS.length]}
                      alt="match"
                  ...
                  <Link to={`/futures?group=${group}`} className="block">
                    ...
                    <div className="bg-primary/5 border border-primary/20 rounded-xl p-3 mb-3">
                          <div className="flex items-center justify-between">
                            ...
                            <Badge className="bg-accent/20 text-accent border border-accent/30 text-xs sm:text-base font-bold px-2 py-0.5 sm:px-3 sm:py-1">
        ...
        <div className="relative z-10 space-y-5">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex items-center gap-2 flex-wrap">
              ...
              {/* Telegram */}
              <a href="https://t.me/elevenXbets" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center hover:bg-blue-500/20 hover:border-blue-500/30 transition-all group">
